                                    ...
                                    <div key={item.uniqueId} className="flex flex-col md:flex-row md:items-center p-3 rounded-xl bg-white border border-transparent hover:border-gray-200 hover:shadow-md transition-all relative group/item">
                                        ...
                                        <div className="flex items-center justify-between mt-2 md:mt-0 md:ml-6 gap-6">
                                            ...
                                            <div className="flex items-center gap-2">
                                                ...
                                                <button onClick={() => handleStartReplace(item)} className="p-2.5 text-gray-400 hover:text-blue-600 rounded-lg hover:bg-blue-50 transition-colors" title="更換商品"><RefreshCw className="h-5 w-5" /></button>
                                                <button onClick={() => handleRemoveProduct(item.id)} className="p-2.5 text-gray-400 hover:text-red-600 rounded-lg hover:bg-red-50 transition-colors"><Trash2 className="h-5 w-5" /></button>
                                            </div>
                                        </div>
                                    </div>
                                );
