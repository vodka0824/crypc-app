    ...
    <div className="fixed inset-0 z-[11000] flex items-start justify-center bg-gray-900/95 backdrop-blur-sm overflow-y-auto print:p-0 print:bg-white print:static print:block">
      ...
      <div className="fixed top-0 left-0 right-0 bg-gray-900/90 backdrop-blur-md p-4 flex justify-between items-center text-white print:hidden z-50 shadow-md border-b border-gray-700">
        ...
        <div className="flex gap-3">
            <button 
                onClick={handlePrint}
                className="flex items-center gap-2 bg-blue-600 hover:bg-blue-500 px-4 py-2 rounded-xl font-medium transition-colors text-sm sm:text-base shadow-lg shadow-blue-900/20 active:scale-95"
            >
            ...
            <button 
                onClick={onClose}
                className="flex items-center gap-2 bg-white/10 hover:bg-white/20 px-4 py-2 rounded-xl font-medium transition-colors text-sm sm:text-base active:scale-95"
            >
                <X className="h-4 w-4" /> 
      ...
      {/* A4 Paper Container with Drop Shadow and Watermark */}
      <div className="bg-white text-black w-full md:max-w-[210mm] min-h-[297mm] mx-auto mt-[72px] md:my-20 p-8 md:p-12 shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] print:shadow-none print:m-0 print:w-full print:max-w-none print:h-auto rounded-sm flex flex-col relative animate-scale-in watermark-bg">
        
        {/* Header */}
        <div className="flex flex-col md:flex-row justify-between items-start border-b-2 border-black pb-6 mb-6 gap-6 md:gap-0 relative z-10">
            <div>
            ...
            <div className="w-full md:w-auto text-left md:text-right flex flex-row md:flex-col justify-between md:justify-start gap-4 md:gap-0 border-t md:border-t-0 border-gray-100 pt-4 md:pt-0">
                <div className="mb-0 md:mb-2">
                    <span className="text-gray-500 text-xs md:text-sm block uppercase tracking-wider font-bold">報價單號</span>
                    <span className="font-mono font-bold text-lg md:text-xl">{quoteId}</span>
                </div>
                <div>
                    <span className="text-gray-500 text-xs md:text-sm block uppercase tracking-wider font-bold">日期</span>
        ...
        {/* Customer Info */}
        <div className="mb-6 p-4 bg-white/80 border border-gray-200 rounded print:bg-transparent print:border-none print:p-0 relative z-10">
                ...
                <div>
                    ...
                    <div className="flex items-center border-b border-gray-300 print:border-b-0">
                        ...
                        <input 
                            ...
                            placeholder="請輸入客戶姓名"
                            className="flex-1 bg-transparent focus:outline-none py-1 font-bold text-lg text-gray-900 placeholder-gray-300 print:placeholder-transparent focus:bg-white/50 transition-colors"
                        />
                    </div>
                </div>
                <div>
                    ...
                    <div className="flex items-center border-b border-gray-300 print:border-b-0">
                        ...
                        <input 
                            ...
                            placeholder="請輸入聯絡電話"
                            className="flex-1 bg-transparent focus:outline-none py-1 font-mono text-lg text-gray-900 placeholder-gray-300 print:placeholder-transparent focus:bg-white/50 transition-colors"
                        />
                    </div>
                </div>
            </div>
            ...
            <table className="w-full text-left border-collapse">
                ...
                <tbody className="divide-y divide-gray-200">
                    {items.map((item, index) => (
                        <tr key={item.id} className="text-sm">
                            <td className="py-3 px-2 text-center text-gray-500 align-top font-mono">{index + 1}</td>
                ...
                <tfoot>
                    <tr className="border-t-2 border-black">
                        <td colSpan={3} className="pt-4 text-right font-bold text-gray-600 text-lg uppercase">總計 (Total):</td>
        ...
        {/* Remarks */}
        <div className="mt-6 border-t border-gray-200 pt-4 print:mt-4 print:border-t-0 relative z-10">
            ...
            <textarea
                ...
                className="w-full min-h-[80px] bg-gray-50/50 hover:bg-white focus:bg-white border border-gray-200 focus:border-black rounded-xl p-3 text-sm outline-none transition-all resize-none shadow-sm focus:ring-4 focus:ring-gray-100 print:shadow-none print:bg-transparent print:border print:border-gray-300 print:p-2 print:resize-none print:placeholder-transparent print:min-h-[60px] font-medium text-gray-900"
            />
        </div>

        {/* Footer */}
        <div className="mt-8 pt-6 border-t-2 border-black grid grid-cols-1 md:grid-cols-2 gap-8 text-xs text-gray-500 break-inside-avoid relative z-10">
            <div>
        ...
        <div className="mt-8 text-center text-[10px] text-gray-400 font-mono border-t border-gray-100 pt-2 relative z-10">
