...
const ProductImportModal: React.FC<ProductImportModalProps> = ({ isOpen, onClose }) => {
  ...
  const csvTemplates: Record<string, string> = {
    ...
    [Category.RAM]: `id,name,price,category,description,type,capacity\nram-demo,Kingston Fury Beast 32GB,3200,記憶體,DDR5-6000/CL30/黑,DDR5,32GB`,
    ...
    [Category.COOLER]: `id,name,price,category,description,brand,type,size,coolerHeight\ncooler-demo,Valkyrie A360,4990,散熱器(水冷),360mm/2.4吋螢幕,Valkyrie,水冷,360mm,55mm`,
